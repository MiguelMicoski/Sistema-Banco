...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente: IComparable
    {
        ...
        /// <summary>
        /// Realiza o Saque e atualiza o valor da propridade <see cref="Saldo"/>
        /// </summary>
        /// <param name="valor">Representa o valor do saque, deve ser maior que zero e menor que o <see cref="Saldo"/></param>
        /// <exception cref="ArgumentException">Execeção lançada quando um valor negativo é utilizado no argumento <paramref name="valor"/>.</exception>
        /// <exception cref="SaldoInsuficienteException">Execeção lançada quando o valor de <paramref name="valor"/> é maior que o valor da propriedade <see cref="Saldo"/>.</exception>
